...
<div>
    ...
    <ul style={{listStyle: "square"}} className="md:ml-5 ml-1 md:text-lg text-base">
        ...
        <ol style={{listStyle: "roman"}} className="md:ml-10 ml-6 my-2 md:text-lg text-base">
            ...
            <li className="text-lg font-bold"><p className="md:text-lg text-base font-normal">
                Prem el botó dret del ratolí sobre qualsevol posició buida en aquesta nova
                finestra i s'obrirà una finestra d'opcions. Escolleix "descarregat la pàgina".</p>
            </li>
            <li className="my-3 text-lg font-bold mb-4"><p className="md:text-lg text-base font-normal">
                Descarrega la pàgina al disc, vigila que l'opció "Pàgina HTML sola" esta escollida:</p>
            <div className="text-center my-2">
                <img className="inline-block mb-3" src="/img/nomesHTML.png" alt="llistat d'opcions d'edició" />
                <p className="md:text-lg text-base font-normal">No et descarreguis la pàgina web completa, només l'HTML!</p>
                </div>
            </li>
        </ol>
        <li className="my-3">Un cop tens la pàgina html del llibre o capítol al disc, busca-la i arrossega-la
            sobre la capsa. O prem sobre la capsa i busca-la al disc.<br/>
            Recorda que cal que t'hagis connectat al campus fa poc perquè
            pugui accedir a les imatges del llibre. Si no, no apareixeràn.
        </li>
        <li className="my-3">Al cap d'un moment, s'obrirà la finestra d'impressió amb els continguts 
            de la pàgina. Cal que escolleixis "salva a PDF" a menys que 
            vulguis imprimir-la.
            <div className="text-center">
                <img className="inline-block mt-3" src="/img/salvaPDF.png" alt="llistat d'opcions d'edició" />
                </div>
        </li>
    </ul>
</div>;
