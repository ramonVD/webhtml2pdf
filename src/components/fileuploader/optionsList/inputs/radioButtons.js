...
const createDefaultRadioJSX = (text, pos, amIChecked, setterFunction, options={}) => {
    ...
    const inputDefaultClass = `form-check-input appearance-none rounded-full h-4 w-4 border
    ...
    const labelDefaultClass = "inline-block text-gray-800 cursor-pointer mb-2 ";
    return(
